<template>
  <router-link class="shop_container" to="/shop">
    <ul class="shop_list">
      <li class="shop_li border-1px" v-for="(item,index) in shops" :key="index">
        <a>
          <div class="shop_left">
            <img class="shop_img" :src="url+item.image_url">
          </div>
          <div class="shop_right">
            <section class="shop_detail_header">
              <h4 class="shop_title ellipsis">{{item.name}}</h4>
              <ul class="shop_detail_ul">
                <li class="supports" v-for="(item2,index) in item.supports" :key="index">{{item2.icon_name}}</li>
              </ul>
            </section>
